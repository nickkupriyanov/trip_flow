...
>(({ className, ...props }, ref) => (
  <th
    className={cn("h-12 px-4 text-left align-middle text-xs font-semibold uppercase tracking-normal text-muted-foreground", className)}
    ref={ref}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <td className={cn("px-4 py-4 align-top", className)} ref={ref} {...props} />
));
